...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      title: "Manufacturing",
      description: "State-of-the-art fabrication facilities with advanced process nodes, ensuring high-yield production at scale.",
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: "Testing & QA",
      description: "Comprehensive testing and quality assurance protocols to ensure reliability and performance standards.",
    },
    {
      icon: (
        <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      title: "Consulting",
      description: "Expert guidance on technology selection, architecture design, and implementation strategies.",
    },
  ];
      ...
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div
              key={index}
              className="bg-white p-8 rounded-xl border border-gray-200 card-hover"
            >
