...
export default function Stats() {
  const stats = [
    { value: "25+", label: "Years of Excellence", description: "Industry-leading experience" },
    { value: "500+", label: "Projects Delivered", description: "Successful implementations" },
    { value: "50+", label: "Global Clients", description: "Trusted partnerships" },
    { value: "200+", label: "Expert Team", description: "Skilled professionals" },
  ];
